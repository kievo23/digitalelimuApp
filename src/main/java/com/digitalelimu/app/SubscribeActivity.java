...
public class SubscribeActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.subscriptions:
                Intent intent = new Intent(SubscribeActivity.this, SubscribeActivity.class);
    ...
    protected void openLoadWalletDialog() {
        AlertDialog.Builder mbuilder = new AlertDialog.Builder(SubscribeActivity.this);
        ...
        loadwalletbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(SubscribeActivity.this, "Load Initiated", Toast.LENGTH_SHORT).show();
                AndroidNetworking.post(Application.domain+"api/walletstkpush")
                        ...
                        .getAsJSONObject(new JSONObjectRequestListener() {
                            ...
                            public void onResponse(JSONObject response) {
                                ...
                                try {
                                    ...
                                    if ("Success. Request accepted for processing".equals(jsonobj.getString("CustomerMessage"))){
                                        Toast.makeText(SubscribeActivity.this, jsonobj.getString("CustomerMessage"), Toast.LENGTH_SHORT).show();

                                        Thread.sleep(10);
                                        dialogload.cancel();
                                    }else {
                                        Toast.makeText(SubscribeActivity.this, "Kindly Try Again", Toast.LENGTH_SHORT).show();
                                    }
                            ...
                            public void onError(ANError error) {
                                // handle error
                                Toast.makeText(SubscribeActivity.this, error.toString(), Toast.LENGTH_SHORT).show();
                            }
                        });
            }
        });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //qued.add(request);
        SingleTone.getInstance(SubscribeActivity.this).getRequestQue().add(request);
    ...
    private class BookAdapter extends RecyclerView.Adapter<BookAdapter.ViewHolder> implements View.OnClickListener {
        ...
        public void onBindViewHolder(BookAdapter.ViewHolder holder, int position) {
            ...
            SubscribeActivity.this.importImage("http://books.academicsage.com/uploads/"+topics.photo,holder.imageView);
                        ...
                        call.enqueue(new Callback<ReadBook>() {
                            ...
                            public void onResponse(Call<ReadBook> call, retrofit2.Response<ReadBook> response) {
                                ...
                                if(("0001").equals(term.getClientId().toString())){
                                    Toast.makeText(SubscribeActivity.this, term.getAmount(), Toast.LENGTH_SHORT).show();
                                    ...
                                    stkContinue.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View view) {
                                            ...
                                            if(walletamt.isEmpty()){
                                                Toast.makeText(SubscribeActivity.this, "Price Should Not Be Empty", Toast.LENGTH_SHORT).show();
                                            }
                                            else if(Integer.parseInt(walletamt) < 5){
                                                Toast.makeText(SubscribeActivity.this, "Price Should Not Be Less Than 5 Bob", Toast.LENGTH_SHORT).show();
                                            }else{
                                    ...
                                    stkpush.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View view) {
                                            ...
                                            if(safAmount.isEmpty()){
                                                ...
                                                Toast.makeText(SubscribeActivity.this, "Please wait a moment", Toast.LENGTH_LONG).show();
                                                            ...
                                                            public void onResponse(JSONObject response) {
                                                                ...
                                                                try {
                                                                    ...
                                                                    if ("Success. Request accepted for processing".equals(code)) {
                                                                        Toast.makeText(SubscribeActivity.this, code, Toast.LENGTH_SHORT).show();
                                    ...
                                    airtel.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View view) {
                                            ...
                                            Intent intent = new Intent(SubscribeActivity.this, PesapalActivity.class);
                                            intent.putExtra("phone",phone);
                                    ...
                                    Intent intent = new Intent(SubscribeActivity.this, TermActivity.class);
